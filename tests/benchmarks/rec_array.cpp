...
int main(int argc, char *argv[])
{
	...
	// (needed only once)
	/*geom.write("./comp_data/test_3/geom.txt");
	fluid.write_f("./comp_data/test_3/f_cpp");
	return 0;
	*/
	...
	string file_comp("./comp_data/test_3/f_cor");
	if (!compare_f(file_comp, fluid, 1e-5)){
		std::cout << "\033[33;1;101m - Test 3 FAILED \033[0m" << std::endl;
		exit(1);
	}else{
		std::cout << "\033[34;1;106m - Test 3 passed \033[0m" << std::endl;
	}
